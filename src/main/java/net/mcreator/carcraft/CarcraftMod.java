...
@Mod("carcraft")
public class CarcraftMod {
	public static final Logger LOGGER = LogManager.getLogger(CarcraftMod.class);
	public static final String MODID = "carcraft";

	public CarcraftMod(IEventBus modEventBus) {
